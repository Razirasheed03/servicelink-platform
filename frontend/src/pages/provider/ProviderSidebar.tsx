...
export default function ProviderSidebar() {
    ...
    const items = [
        ...
        { key: "jobs", label: "Jobs", icon: ClipboardList, to: "/provider/jobs" },
        { key: "calendar", label: "Schedule", icon: Calendar, to: "/provider/schedule" },
        { key: "earnings", label: "Earnings", icon: DollarSign, to: "/provider/earnings" },
